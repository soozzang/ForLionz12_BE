...
public class ChildCommentController {
    ...
    @PostMapping
    public ApiResponse<ChildCommentResponseIdDto> createChildComment(@RequestBody ChildCommentRequestDto request) {
        ...
        return ApiResponse.createSuccess(new ChildCommentResponseIdDto(childcomment));
    }
